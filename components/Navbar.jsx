  ...
  return (
    ...
    >
      ...
      <div
        ...
        text-sm flex flex-col space-x-0 space-y-3 h-screen bg-gray-50 fixed top-0 right-0 w-1/2 border-l border-gray-200 pt-4 font-medium
      ...
      >
        ...
        <Link href='/'>
          <a className='md:py-0 py-3 md:w-min w-full text-center transition-colors hover:bg-gray-200 md:hover:bg-transparent md:hover:underline'>
            Home
          </a>
        </Link>
        <Link href='/store'>
        ...
        <Link href='/cart' passHref>
          <a className='md:py-0 py-3 md:w-min w-full text-center transition-colors hover:bg-gray-200 md:hover:bg-transparent'>
